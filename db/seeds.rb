...
# Activity.create(name: "The Louvre", description: "the Louvre Museum, is the world's largest art museum and a historic monument in Paris, France. A central landmark of the city, it is located on the Right Bank of the Seine in the city's 1st arrondissement (district or ward). Approximately 38,000 objects from prehistory to the 21st century are exhibited over an area of 72,735 square metres (782,910 square feet).", destination_id: 1, thumbnail: "http://cityspirits.eu/wp-content/uploads/2015/10/louvresemiprivate.jpg")
...
# Trip.create(name: "Shawn in Paris", start_date: "2018-08-16 21:44:35", end_date: "2018-08-26 21:44:35", destination_id: 1)
...
# TripActivity.create(trip_id: 3, activity_id: 2)
# TripActivity.create(trip_id: 3, activity_id: 4)
